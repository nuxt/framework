<template>
  <div class="overflow-hidden relative pt-12">
    <div class="flex flex-wrap items-center justify-center py-0 section d-container-content">
      <section class="flex flex-col justify-start w-full px-4 pb-24 sm:pt-12 sm:pb-36 lg:pt-24 lg:pb-50 text-center z-20">
        ...
        <Gem class="block m-x-auto w-full" />
