...
Currently, [Nuxt 2](https://github.com/nuxt/nuxt.js) is considered **stable** version.
Lastest updates on Nuxt 2.x are available via `nuxt-edge` npm package and expected to release alongside first release candidate of Nuxt 3 for future compatibility. [Nuxt 3](https://v3.nuxtjs.org) is **under development** and available as `nuxt3` npm package with automated releases for beta testing.
...
In roadmap below, we listed major expected features that comming soon with Nuxt 3.
...
Seo & PWA     | Q2 2022       | [nuxt/framework#1823](https://github.com/nuxt/framework/discussions/1823) | Migrating from [nuxt-community/pwa-module](https://github.com/nuxt-community/auth-module) for built-in SEO utils and Server-worker support
...
Alongside with Nuxt Framework, there are modules that are vital for ecosystem. Their status will be updated below.
