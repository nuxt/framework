...
If you need to access request headers during server-side-rendering, you can use [`useRequestHeaders`](/docs/usage/ssr) and in order to browser cookies to the API.
