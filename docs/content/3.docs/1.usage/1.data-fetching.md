...
::alert{icon=👉}
Using `<script setup>` is preferred and allows Vue to compile in some magic to solve this issue. [Read more.](https://v3.vuejs.org/api/sfc-script-setup.html#top-level-await)
::
