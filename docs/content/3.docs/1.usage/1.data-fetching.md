...
There are instances where you may need to directly call the API. Next 3 provides globally available `$fetch` method using [unjs/ohmyfetch](https://github.com/unjs/ohmyfetch) as well as `fetch`
