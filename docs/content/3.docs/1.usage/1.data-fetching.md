...
If you need to access request headers or cookies within your Nitro endpoint, you can use [`useReqHeaders`](/docs/usage/ssr) to proxy them. (Without this, you won't be able to access them on the initial server-side render.) For example:
