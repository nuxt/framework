...
Nuxt 3 provides a lot of new options for [fetching data from an API](/docs/usage/data-fetching). Most of the new options involve composable methods provided by Nuxt 3.
...
You can read more [in the docs](/concepts/server-engine#direct-api-calls).
