...
Nuxt 2 modules should be forward compatible with Nuxt 3 as long as users migrate to Bridge, or if modules are already following guidelines.
...
You could check [Nuxt Modules](https://modules.nuxtjs.org/) for modules compatibility and as a reference for the project setup from other modules.
