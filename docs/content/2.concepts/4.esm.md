...
### Redirecting default import

Default imports for CommonJS modules might need a special handling.
For example:
```js
import VueTailwind from "vue-tailwind"
const VueTailwindPlugin = VueTailwind.default?.default || VueTailwind.default || VueTailwind

// Now in place of VueTailwind use VueTailwindPlugin
