...
Nuxt uses Vue as a user-interface framework, and adds features such as components auto-imports and file-based routing. Nuxt 3 integrates Vue 3, the new major release of Vue that enables new patterns for Nuxt users.
...
Nuxt has always used Vue as a user-interface framework. We chose to build Nuxt in top of Vue for these reasons:
