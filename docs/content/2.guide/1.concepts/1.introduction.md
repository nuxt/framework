...
On top of this setup, Nuxt provides a [directory structure](/api-reference/directory-structure) to follow, focused on specific features to keep your focus on creating, not configuring.
