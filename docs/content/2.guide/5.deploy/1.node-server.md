...
Another way of starting a multi-process server with a Node.js internal module, is, using the [cluster](https://nodejs.org/dist/latest/docs/api/cluster.html) module:
