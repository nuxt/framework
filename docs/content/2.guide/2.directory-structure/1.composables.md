...
Avoid calling another composable in a scope outside the composable function, it will fail to find a Nuxt instance.
As Pooya explained in a similar issue this happens because:
...
Long story short:
> Composition API and Nuxt Composables are only available during lifecycle and in same tick...
