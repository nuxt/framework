...
**Otherwise, go to the next chapter to discover another key feature of Nuxt: [Rendering modes](/guide/key-concepts/rendering)**.
...
::alert{type="info"}
🔎 [Read the details about Typescript in Nuxt 3](/guide/key-concepts/typescript)
::
