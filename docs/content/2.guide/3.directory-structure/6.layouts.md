...
If you only have a single layout in your application, we recommend to use [app.vue](/api-reference/directory-structure/app) instead.
...
::alert{type=info}
Learn more about [defining page meta](/api-reference/directory-structure/pages#page-metadata).
::
