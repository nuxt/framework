...
If returning a falsy value, Nuxt will fallback to the default routes. (useful to modify input array)
...
If returning a falsy value, Nuxt will fallback to the default history.
