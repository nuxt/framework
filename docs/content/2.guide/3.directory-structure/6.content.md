...
::alert{type=info}
Head over to <https://content.nuxtjs.org> to learn more about the Content module features, like how to build queries and use Vue components in your Markdown files with the MDC syntax.
::
