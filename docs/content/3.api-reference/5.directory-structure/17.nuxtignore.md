...
**Note**: You can also configure [`ignoreOptions`](/api-reference/directory-structure/nuxt.config#ignoreoptions), [`ignorePrefix`](/api-reference/directory-structure/nuxt.config#ignoreprefix) and [`ignore`](/api-reference/directory-structure/nuxt.config#ignore) in your `nuxt.config` file.
