...
- Remove `@nuxtjs/composition-api`: Bridge provides a Nuxt 3 compatible composition-api layer and help to remove dependency. Enjoy new auto import functionality or replace all imports from `@nuxtjs/composition-api` by imports from `#app`.
