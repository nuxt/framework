...
- Remove `@nuxtjs/composition-api`: Bridge provides a Nuxt 3 compatible composition-api layer and help to remove dependency. Replace all imports from `@nuxtjs/composition-api` by imports from `@vue/composition-api`.
