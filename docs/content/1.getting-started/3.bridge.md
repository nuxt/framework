...
- Remove `@nuxtjs/composition-api` from your dependencies (and from your modules in `nuxt.config`). [Read the full migration guide here](/getting-started/bridge/composition-api).
