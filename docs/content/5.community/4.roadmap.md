...
Image          | Active              | 2.x          | [nuxt/image](https://github.com/nuxt/image) | Nuxt 3 support is in progress: [nuxt/image#500]([nuxt/image/issues/500](https://github.com/nuxt/image/issues/500))
