...
To do so you can modify the example app in `playground/`, and run it with `yarn dev`. Make sure not to commit it to your branch, but it could be helpful to add some example code to your PR description. This can help reviewers and other Nuxt users understand the feature you've built in-depth.
...
In order to contribute to Nuxt, you need to setup a local environment.
...
1. Ensure using latest Node.js (16.x)
...
1. Run `yarn stub` to activate passive development system
