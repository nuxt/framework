...
export const pluginsDeclaration = {
  ...
  getContents: (ctx: TemplateContext) => {
    ...
    return [
      ...
      '',
      `type PluginReturns = ${tsImports.map(p => `InjectionType<typeof import('${p}').default>`).join(' & ')
    }`,
      '',
      'declare module \'#app\' {',
      '  interface NuxtAppInjections extends PluginReturns { }',
      '}',
      '',
      'declare module \'@vue/runtime-core\' {',
      '  interface ComponentCustomProperties extends PluginReturns { }',
      '}',
      '',
      'export { }'
    ].join('\n')
