...
export default function nuxt2CompatModule () {
  ...
  nitroDevContext._internal.hooks.hook('nitro:template', template => nuxt.callHook('nitro:template', template))
  ...
  nitroContext._internal.hooks.hook('nitro:template', (htmlTemplate) => {
